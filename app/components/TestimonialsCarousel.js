...
const testimonials = [
    {
        ...
        text: "אחרי שנים של מינוס קבוע, FinSmart עזרו לנו לבנות תוכנית חיסכון ריאלית. תוך 4 חודשים יצאנו מהמינוס ואנחנו חוסכים 2,000 ₪ בחודש!",
        savings: "₪2,000 לחודש",
        avatar: "ר",
    },
    {
        ...
        text: "ידעתי שאני צריך לחסוך לפנסיה אבל לא ידעתי מאיפה להתחיל. היועץ מ-FinSmart הסביר לי הכל בשפה פשוטה ובנינו תיק השקעות שמיועד לגיל שלי.",
    ...
    },
    {
        ...
        text: "קיבלנו החזר מס של 18,000 ₪ שלא ידענו שמגיע לנו. FinSmart בדקו לנו 5 שנים אחורה וגילו כסף שסתם ישב אצל המדינה!",
