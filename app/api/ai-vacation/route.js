...
export async function POST(req) {
    ...
    try {
        ...
        const prompt = `
אתה יועץ פיננסי שיווקי עבור חברת "PageLending".
...
החזר *אך ורק* JSON במבנה הבא (בלי markdown מסביב):
{
  ...
  "punchline": "משפט סיום מכירתי עוצמתי שקורא לו לתאם פגישה עם PageLending כדי לתכנן לא רק טיול, אלא חירות כלכלית."
}
`;
